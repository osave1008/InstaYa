                    ...
                    <div id="layoutSidenav_content">
                        <main>
                            <div className="container-fluid px-4">
                                <h1 className="mt-4">Actualizacion de Ordenes</h1>
                                <ol className="breadcrumb mb-4">
                                    <li className="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                    <li className="breadcrumb-item active">Actualizacion&nbsp;</li>
                                </ol>                        
                                    ...
                                    <form>
                                        ...
                                        <div className="row mb-4">
                                            <div className="mt-4 mb-0">
                                                <div className="d-grid"><a className="btn btn-primary btn-block" href="tables.html">Actualizar</a></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
